...
// This is the URL of a search for the latest tweets on the '#DevFit' hashtag.
const mediaArtsSearch = { q: "#devfit", count: 100, result_type: "recent" };

// This function finds the latest tweet with the DevFit hashtag and retweets.
const retweetLatest = () => {
